  ...
  Future<List<Map<String, dynamic>>> fetchTransactionsByStatus(
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
            '$apiBaseUrl/transactions?payment_status=$status&type=3'), // ✅ Memperbaiki query parameter
        headers: {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (products.any((p) => p['transaction_type'] == 1)) ...[
                        const Padding(
                        ...
                        ...products
                            .where(
                                (product) => product['transaction_type'] == 1)
                            .map((product) => _buildProductRow(product))
                            .toList(),
                      ],

                      if (products.any((p) => p['transaction_type'] == 2)) ...[
                        const Padding(
                        ...
                        ...products
                            .where(
                                (product) => product['transaction_type'] == 2)
                            .map((product) => _buildProductRow(product))
                            .toList(),
                      ],
