  ...
  Future<List<Map<String, dynamic>>> fetchTransactionsByStatus(
    ...
    try {
      final response = await http.get(
        Uri.parse('$apiBaseUrl/transactions?payment_status=$status&type=2'),
        headers: {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Penjualan Anda akan muncul di sini',
            style: TextStyle(
              fontSize: 14,
        ...
        return Container(
          ...
          child: ClipRRect(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () => context.push('/salesd/${order['id']}'),
                borderRadius: BorderRadius.circular(16),
                child: Column(
                  children: [
                    // Order Header
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          if (order['status'] == 1)
                            _buildStatusBadge("Paid", accentColor),
                          if (order['status'] == 2)
